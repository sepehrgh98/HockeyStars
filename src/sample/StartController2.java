...
public class StartController2 {
    ...
    void initialize() {
        ...
        players1[0] = new Players(366, 225, 10, Color.RED);
        players1[1] = new Players(366, 140, 10, Color.RED);
        players1[2] = new Players(366, 300, 10, Color.RED);
        players1[3] = new Players(435, 274, 10, Color.RED);
        players1[4] = new Players(490, 225, 10, Color.RED);
        players1[5] = new Players(435,188,10,Color.RED);

        players2 = new Players[n];
        players2[0] = new Players(234, 225, 10, Color.BLUE);
        players2[1] = new Players(234, 140, 10, Color.BLUE);
        players2[2] = new Players(165, 274, 10, Color.BLUE);
        players2[3] = new Players(165, 188, 10, Color.BLUE);
        players2[4] = new Players(110, 225, 10, Color.BLUE);
        players2[5] = new Players(234,300,10,Color.BLUE);

        ball= new Ball(300, 226, 7, Color.BLACK);
    ...
    public void aftergoal(long now){
        if(now/1000000000.0-afgtime/1000000000.0 >2){
            if (player1goal!=3&&player2goal!=3) {
            ...
            if (p1goalch.get() == true) {
                if (player1goal == 3) {
                    reportext.setText("PLAYER 1 WINNED THE GAME !");
                    runanim.set(false);
                }
                else if(player2goal!=3) {
            ...
            if (p2goalch.get() == true) {
                if (player2goal==3){
                    reportext.setText(" PLAYER 2 WINNED THE GAME !");
                    runanim.set(false);
                }
                else if (player1goal!=3){
